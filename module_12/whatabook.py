...
def show_books_to_remove(_cursor, _user_id):
    ...
    books_to_remove = _cursor.fetchall()
...
def remove_book_from_wishlist(_cursor, _user_id, _book_id):
    _cursor.execute("DELETE FROM wishlist WHERE user_id = {} AND book_id = {}".format(_user_id, _book_id))
        ...
        if user_selection == 3:
            ...
            while account_option != 4:
                ...
                if account_option == 3:
                    ...
                    remove_book_from_wishlist(cursor, my_user_id, book_id)
                    db.commit()
                    print("\n        Book id: {} was removed from your wishlist!".format(book_id))
